...
namespace KarateKlub.Web.Areas.ModulSekretar.Controllers
{
    ...
    public class TroskoviTakmicenjaController : Controller
    {
        ...
        // GET: ModulSekretar/TroskoviTakmicenja
        ...
        public ActionResult SpremiNoviTrosakTamicenja(TroskoviTakmicenjaDodajVM model)
        {
            ...
            return RedirectToAction("Index", "UpravljanjeTakmicenjima", new { takmicenjeId = model.TakmicenjeId, brojTaba = 2, brojTabaRezultati = 1 });
