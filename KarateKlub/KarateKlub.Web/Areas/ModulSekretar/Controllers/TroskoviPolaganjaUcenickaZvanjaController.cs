...
namespace KarateKlub.Web.Areas.ModulSekretar.Controllers
{
    ...
    public class TroskoviPolaganjaUcenickaZvanjaController : Controller
    {
        ...
        // GET: ModulSekretar/TroskoviPolaganjaUcenickaZvanja
        ...
        public ActionResult SpremiNoviTrosakPolaganjaUcenickaZvanja(TroskoviPolaganjaUcenickaZvanjaDodajVM model)
        {
            ...
            ctx.SaveChanges();
            return RedirectToAction("Index", "UpravljanjePolaganjaUcenickaZvanja", new { polaganjeId = model.PolaganjeUcenickaZvanjaId, brojTaba = 4, zvanje =0 });
