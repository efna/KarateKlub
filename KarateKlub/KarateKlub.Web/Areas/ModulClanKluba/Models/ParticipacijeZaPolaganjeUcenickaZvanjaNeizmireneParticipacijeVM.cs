...
namespace KarateKlub.Web.Areas.ModulClanKluba.Models
{
    ...
    public class ParticipacijeZaPolaganjeUcenickaZvanjaNeizmireneParticipacijeVM
    {
        ...
        public ParticipacijeZaPolaganjeUcenickaZvanjaNeizmireneParticipacijeVM(List<UcesniciPolaganjaZaUcenickaZvanja> listaUcesnikNijePlatio, int osobaId, int izmirena)
        {
