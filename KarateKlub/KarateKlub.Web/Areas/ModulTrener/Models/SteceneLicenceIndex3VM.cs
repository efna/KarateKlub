...
{
    public class SteceneLicenceIndex3VM
    {
        public List<StecenaLicencaPodaci> steceneLicence;
        public int aktivnost { get; set; }
        public List<SelectListItem> Aktivnost { get; set; }

        public SteceneLicenceIndex3VM(List<SteceneLicence> licence, int aktivnost)
        {
            steceneLicence = licence.Select(x => new StecenaLicencaPodaci
            {
                Id = x.Id,
